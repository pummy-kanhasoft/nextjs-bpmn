...
const App = () => {
  useEffect(() => {
    ...
    const modelerContainer = document.querySelector('#canvas1');
  ...
  return (
    ...
    <div className="modeler1" id="modeler" style={{ display: "flex", width: "100%", height: "700px" }}>
      <div id="canvas1" style={{ width: "80%" }}></div>
